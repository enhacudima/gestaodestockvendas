    	...
    	if($request->ajax())
        {
        	...
        	$identificador_de_bulk='mesa'.'_'.time();
          	...
          	foreach ($data_mesa as $key => $value) {
          		$output.=
          			'<input type="text" id="idbulk" name="idbulk" hidden="true" value="'.$value->identificador_de_bulk.'"><input type="number" id="id[]" name="id[]" hidden="true" value="'.$value->id.'"><input type="text" name="produt" id="produt" style="margin-right: 13px; width: 70%" disabled="" value="'.$value->name.'"> <input  type="number" name="preco_final[]" id="preco_final[]" style="width: 60px; margin-right: 13px" disabled="true" value="'.$value->preco_final.'"><input  type="number" name="quantidade[]" id="quantidade[]" style="width: 67px;margin-right: 13px" value="'.$value->quantidade.'"><input  type="number" name="total[]" id="total[]" style="width: 75px; margin-right: 13px"  disabled="true"  value="'.$value->quantidade * $value->preco_final.'">';
          	}
