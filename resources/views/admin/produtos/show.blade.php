        ...
        <form method="post" action="{{url('produto/update',$produtos->id)}}" autocomplete="Active" accept-charset="UTF-8" >
            ...
            <div class="row">
                    <div class="from-group col-lg-12">
                        ...
                        <input type="date" name="dataentrada" id="dataentrada" class="form-control" value="{{$produtos->dataentrada}}" required autofocus>
                    </div>
            </div>  
            ...
            <div class="row">
                    <div class="from-group col-lg-12">
                        ...
                        <input type="date" name="dataexpiracao" id="dataexpiracao" class="form-control" value="{{$produtos->dataexpiracao}}" >
                    </div>
            </div> 
            ...
            <div class="row">
                    <div class="from-group col-lg-12">
                        ...
                        <input type="text" name="fornecedor" id="fornecedor" class="form-control" value="{{$produtos->fornecedor}}" required autofocus>
                    </div>
            </div>  
            <div class="row">
                    <div class="from-group col-lg-12">
                        <label>Preço de compra</label>
                        <input type="number" name="precocompra" id="precocompra" class="form-control" value="{{$produtos->precocompra}}" required autofocus>
                    </div>
            </div>   
            ...
            <div class="row">
                    <div class="from-group col-lg-12">
                        ...
                        <input type="number" name="precorevenda" id="precorevenda" class="form-control" value="{{$produtos->precorevenda}}" required autofocus>
                    </div>
            </div>
